# CoCreate-fullscreen
A simple fullscreen component in vanilla javascript. Easily configured using HTML5 data-attributes and/or JavaScript API. Target attribute to define an "id" of the element you would like to view in fullscreen. If target attribute is not used then will default to the body tag will open in fullscreen. Take it for a spin in our [playground!](https://cocreate.app/docs/fullscreen)
...
[CoCreate Docs](https://cocreate.app/docs/fullscreen)
